...
VALUES 
    ('Designing Data-Intensive Applications', 'The Big Ideas Behind Reliable, Scalable, and Maintainable Systems', 9781449373320, 'O''Reilly Media', 2017, 1, 1, 'en', 552, 10, 1, 1, 1, 'hardcover', 'in progress', '2026-03-27', 'planned'),
    ('The Elements of Statistical Learning', 'Data Mining, Inference, and Prediction', 9780387848587, 'Springer', 2009, 2, 1, 'en', 698, 0, 4, 1, 1, 'hardcover', 'unread', null, 'unplanned');
